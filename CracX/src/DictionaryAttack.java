...
/**
 * Funktionalitaet fuer "Dictionary-Attacke" basierend auf einem Woerterbuch
 * @author Till
 *
 */
public class DictionaryAttack extends Observable implements Runnable{
    ...
    public void run() {
        ...
        if(running){ // wenn nach Dictionary noch nicht stop gedrueckt oder Erfolg gehabt, BruteForce
            br.run();
        }
        setChanged();
